    ...
    <div className="about-me mb-70">
      <div className="row mb-70">
        <div className="about-me__main-message">
          ...
          <p>
            I am a fullstack PHP developer for 5 years, specializing in the
            development of payment management and e-commerce sites.
          </p>

          <p>
            I am a certified Scrum Master, with 2 years experience of
            facilitiating scrum activities.
          </p>
        ...
        <div className="about-me__personal-info">
          ...
          <ul className="about-me__personal-info-list">
            ...
            <li>
              <span className="about-me__personal-info-label">
                Phone Number:
              </span>
      ...
      <div className="row about-me__services mb-50">
        ...
        <div className="services__list">
          <div className="services__item">
            ...
            <p>
              Web infrastructure planning, development, deployment, maintenance
              and support
            </p>
          </div>
          <div className="services__item">
            ...
            <p>
              Scrum team facilitation (e.g. Sprint Planning, Sprint
              Restrospective)
            </p>
          </div>
          <div className="services__item">
        ...
        <div className="testimonials__list">
          <div className="testimonial-item">
            <div className="testimonial-item__content">
              <p>
                "Nix is easy to work with because of her wide experience in
                programming. She is professional and does her work on time."
              </p>
            </div>
            <div className="testimonial-item__meta">
              ...
              <div className="testimonial-item__meta-info">
                <h4>Angelo Evora</h4>
                <div>
                  Owner, The Insurance Hub <br /> Financial Adviser, Pru Life UK
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="testimonial-item">
            <div className="testimonial-item__content">
              <p>
                "Nicole has been a real pleasure to work with. She did an
                exceptional job on projects that we worked on together.
                Passionate, great, and creative co-worker. Detail-oriented,
                intelligent, deadline-oriented, and broad-minded colleague. She
                has a vast knowledge and is thorough with her work."
              </p>
            </div>
            <div className="testimonial-item__meta">
              <img src={VillasZedrick} />
              <div className="testimonial-item__meta-info">
                <h4>Zedrick John Villas</h4>
                <div>Program Scrum Master, AXA Philippines</div>
              </div>
            </div>
          </div>
        </div>
